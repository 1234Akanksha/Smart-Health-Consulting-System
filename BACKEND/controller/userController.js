...
export const addNewAdmin = catchAsyncErrors(async (req, res, next) => {
    const { firstName, lastName, email, phone, adharCard, dob, gender, password } = req.body;
...
export const addNewDoctor = catchAsyncErrors(async (req, res, next) => {
    // Check if the doctor avatar file is provided
    ...
    // Create new doctor record, including the avatar URL
    ...
    // Send response with doctor details and avatar info
    res.status(200).json({
        success: true,
